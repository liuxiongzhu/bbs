        ...
        <section class="new_search_box clearfix">
            <div class="search_box">
                <a href="plugin.php?id=tom_tcshop&amp;site=<?php echo $site_id;?>&amp;mod=search">
                    ...
                    <input type="text" readonly="readonly"  value="" placeholder="鎼滃簵閾�">
...
<section class="index-search-box">
    ...
    <section class="index-search-box__bd id_search_btn tc-template__bg">鎼滅储</section>
</section>
</form>
<script>
...
<section class="shop_headlines">
    <div class="shop_headlines-title">鍟嗗湀<span>澶存潯</span></div>
<div class="shop_headlines-list id-index-scroll-ad">
    	<ul>
            <?php if(is_array($newTcshopList)) foreach($newTcshopList as $key => $val) { ?>        	<li><font color="<?php echo $tongchengConfig['template_color'];?>"><?php echo $val['name'];?></font> 鍏ラ┗鎴愬姛</li>
            <?php } ?>
        </ul>
    </div>
    <div class="shop_headlines-ruzhu"><a class="tc-template__bg" href="plugin.php?id=tom_tcshop&amp;site=<?php echo $site_id;?>&amp;mod=ruzhu&amp;prand=<?php echo $prand;?>">绔嬪嵆鍏ラ┗</a></div> 
</section>
<section class="shop_list">
<div class="shop_list-menu">
    	<div class="list-menu"><a <?php if($tab == 1 ) { ?>class="on tc-template__color tc-template__border"<?php } ?> href="plugin.php?id=tom_tcshop&amp;site=<?php echo $site_id;?>&amp;mod=index&amp;tab=1">鎺ㄨ崘</a></div>
    	<div class="list-menu"><a <?php if($tab == 2 ) { ?>class="on tc-template__color tc-template__border"<?php } ?> href="plugin.php?id=tom_tcshop&amp;site=<?php echo $site_id;?>&amp;mod=index&amp;tab=2">鏂板叆</a></div>
    	<div class="list-menu"><a <?php if($tab == 3 ) { ?>class="on tc-template__color tc-template__border"<?php } ?> href="plugin.php?id=tom_tcshop&amp;site=<?php echo $site_id;?>&amp;mod=index&amp;tab=3">闄勮繎</a></div>
    </div>
    <div class="list-item" id="index-list"></div>
    <div class="list-msg" style="display: none;" id="load-html">鍔犺浇涓�...</div>
    <div class="list-msg" style="display: none;" id="no-load-html">娌℃湁鏇村鍟嗗</div>
    <div class="list-msg" style="display: none;" id="no-list-html">娌℃湁鐩稿叧鍟嗗</div>
