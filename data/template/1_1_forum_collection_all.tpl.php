<?php if(!defined('IN_DISCUZ')) exit('Access Denied'); hookscriptoutput('collection_all');
0
|| checktplrefresh('./template/default/forum/collection_all.htm', './template/default/forum/collection_nav.htm', 1550405809, '1', './data/template/1_1_forum_collection_all.tpl.php', './template/default', 'forum/collection_all')
|| checktplrefresh('./template/default/forum/collection_all.htm', './template/default/forum/collection_list.htm', 1550405809, '1', './data/template/1_1_forum_collection_all.tpl.php', './template/default', 'forum/collection_all')
;?><?php include template('common/header'); ?><div id="pt" class="bm cl">
<div class="z">
<a href="./" class="nvhm" title="首页"><?php echo $_G['setting']['bbname'];?></a> <em>&rsaquo;</em>
<a href="forum.php?mod=collection">淘帖</a> <em>&rsaquo;</em>
<a href="forum.php?mod=collection&amp;op=all">所有专辑</a>
</div>
</div>
...
<div class="tbmu cl">
<div class="y">
<?php if($_G['setting']['search']['collection']['status'] && ($_G['group']['allowsearch'] & 64 || $_G['adminid'] == 1)) { ?>
<form action="forum.php?mod=collection&amp;op=search" method="post">
<input type="text" name="kw" class="px vm" />
<button type="submit" value="submit" class="pn vm"><span>搜索</span></button>
</form>
<?php } ?>
</div>
<?php if($op != 'search') { ?>
<a href="forum.php?mod=collection&amp;op=all"<?php if(!in_array($orderby, array('threadnum', 'commentnum', 'follownum'))) { ?> class="a"<?php } ?>>按创建时间排序</a>
<span class="pipe">|</span>
<a href="forum.php?mod=collection&amp;op=all&amp;order=threadnum"<?php if($orderby == 'threadnum') { ?> class="a"<?php } ?>>按主题数排序</a>
<span class="pipe">|</span>
<a href="forum.php?mod=collection&amp;op=all&amp;order=commentnum"<?php if($orderby == 'commentnum') { ?> class="a"<?php } ?>>按评论数排序</a>
<span class="pipe">|</span>
<a href="forum.php?mod=collection&amp;op=all&amp;order=follownum"<?php if($orderby == 'follownum') { ?> class="a"<?php } ?>>按订阅数排序</a>
<?php } else { ?>
搜索
<?php } ?>
</div>
