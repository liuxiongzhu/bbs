...
<title>信息已经不存在 - <?php echo $__SitesInfo['name'];?></title>
       ...
       <div class="tcui-msg">
        ...
        <div class="tcui-msg__opr-area">
            <p class="tcui-btn-area">
                <a href="plugin.php?id=tom_tongcheng&amp;site=<?php echo $site_id;?>&amp;mod=index&amp;prand=<?php echo $prand;?>" class="tcui-btn tcui-btn_default">返回首页</a>
            </p>
        </div>
    </div>
   </section>
