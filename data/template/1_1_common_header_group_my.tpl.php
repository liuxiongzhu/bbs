...
0
|| checktplrefresh('./template/default/common/header.htm', './template/default/common/header_common.htm', 1550473415, '1', './data/template/1_1_common_header_group_my.tpl.php', './template/default', 'common/header_group_my')
|| checktplrefresh('./template/default/common/header.htm', './template/default/common/header_qmenu.htm', 1550473415, '1', './data/template/1_1_common_header_group_my.tpl.php', './template/default', 'common/header_group_my')
|| checktplrefresh('./template/default/common/header.htm', './template/default/common/pubsearchform.htm', 1550473415, '1', './data/template/1_1_common_header_group_my.tpl.php', './template/default', 'common/header_group_my')
;?>
