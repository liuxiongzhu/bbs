...
0
|| checktplrefresh('./template/default/ranklist/group.htm', './template/default/ranklist/side_left.htm', 1550859338, 'diy', './data/template/1_diy_ranklist_group.tpl.php', './template/default', 'ranklist/group')
...
<h1 class="mt">群组排行</h1>
<ul class="tb cl">
<li<?php if($_GET['view'] == 'credit') { ?> class="a"<?php } ?>><a href="misc.php?mod=ranklist&amp;type=group&amp;view=credit">积分排行</a></li>
<li<?php if($_GET['view'] == 'member') { ?> class="a"<?php } ?>><a href="misc.php?mod=ranklist&amp;type=group&amp;view=member">成员数排行</a></li>
<li<?php if($_GET['view'] == 'threads') { ?> class="a"<?php } ?>><a href="misc.php?mod=ranklist&amp;type=group&amp;view=threads">发帖排行</a></li>
<li<?php if($_GET['view'] == 'posts') { ?> class="a"<?php } ?>><a href="misc.php?mod=ranklist&amp;type=group&amp;view=posts">回复排行</a></li>
<li<?php if($_GET['view'] == 'today') { ?> class="a"<?php } ?>><a href="misc.php?mod=ranklist&amp;type=group&amp;view=today">最近 24 小时发帖排行</a></li>
</ul>
<?php if($groupsrank) { ?>
<div class="tl">
...
<th>群组<?php if($_GET['view'] == 'credit') { ?>(群组积分数排行)<?php } ?></th>
<td width="100">
<?php if($_GET['view'] == 'today') { ?>最近 24 小时发帖
<?php } elseif($_GET['view'] == 'posts') { ?>回复
<?php } elseif($_GET['view'] == 'thismonth') { ?>最近 30 天发帖
<?php } elseif($_GET['view'] == 'credit') { ?>积分数
<?php } elseif($_GET['view'] == 'member') { ?>成员数
<?php } else { ?>发帖<?php } ?>
</td>
</tr><?php if(is_array($groupsrank)) foreach($groupsrank as $forum) { ?><tr>
...
<td>
<?php if($_GET['view'] == 'credit') { ?><?php echo $forum['commoncredits'];?>
<?php } elseif($_GET['view'] == 'member') { ?><?php echo $forum['membernum'];?>
<?php } else { ?><?php echo $forum['posts'];?><?php } ?>
</td>
</tr>
<?php } ?>
</table>
