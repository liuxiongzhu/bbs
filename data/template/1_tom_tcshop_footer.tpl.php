...
<footer class="new-footer">
    <section class="new-footer__box dislay-flex">
        ...
        <a class="flex footer-box__item on tc-template__color" href="plugin.php?id=tom_tcshop&amp;site=<?php echo $site_id;?>&amp;mod=index&amp;prand=<?php echo $prand;?>">
            <i class="tciconfont tcicon-shop"></i>
            <section class="text1">好店</section>
        </a>
        <a class="flex footer-box__item footer-box__fabu tc-template__color" href="plugin.php?id=tom_tcshop&amp;site=<?php echo $site_id;?>&amp;mod=ruzhu&amp;prand=<?php echo $prand;?>">
        ...
        <a class="flex footer-box__item  " href="plugin.php?id=tom_tongcheng&amp;site=<?php echo $site_id;?>&amp;mod=message&amp;prand=<?php echo $prand;?>">
            <font class="iconfont">
