...
<footer class="new-footer">
    <section class="new-footer__box dislay-flex">
        ...
        <?php } else { ?>
        <a class="flex footer-box__item <?php if($_GET['mod'] == 'search' ) { ?>tc-template__color on<?php } ?>" href="plugin.php?id=tom_tongcheng&amp;site=<?php echo $site_id;?>&amp;mod=search&amp;prand=<?php echo $prand;?>">
