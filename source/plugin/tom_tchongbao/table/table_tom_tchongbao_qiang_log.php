...
class table_tom_tchongbao_qiang_log extends discuz_table{
	public function __construct() {
        parent::__construct();
		$this->_table = 'tom_tchongbao_qiang_log';
		$this->_pk    = 'id';
	}
    ...
    public function fetch_sum_money($condition) {
        $return = DB::fetch_first("SELECT SUM(money) AS num FROM ".DB::table($this->_table)." WHERE 1 $condition ");
		return $return['num'];
	}
