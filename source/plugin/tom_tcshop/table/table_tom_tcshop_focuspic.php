...
class table_tom_tcshop_focuspic extends discuz_table{
	public function __construct() {
        parent::__construct();
		$this->_table = 'tom_tcshop_focuspic';
		$this->_pk    = 'id';
	}
    ...
    public function delete_by_site_id($site_id) {
		return DB::query("DELETE FROM %t WHERE site_id=%d ", array($this->_table, $site_id));
	}
