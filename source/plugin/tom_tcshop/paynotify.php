...
if($orderInfo && $orderInfo['order_status'] == 1){
    ...
    if($access_token && !empty($toUser['openid'])){
        ...
        if($orderInfo['order_type'] == 4){
            ...
            $template_first = str_replace("{NAME}",$tcshopInfo['name'], lang('plugin/tom_tcshop','xufei_template_first'));
            $template_first = str_replace("{MONEY}",$orderInfo['pay_price'], $template_first);
        }else if($orderInfo['order_type'] == 8){
            $template_first = str_replace("{NAME}",$tcshopInfo['name'], lang('plugin/tom_tcshop','xufei_template_first'));
            $template_first = str_replace("{MONEY}",$orderInfo['pay_price'], $template_first);
        }else if($orderInfo['order_type'] == 9){
            $template_first = str_replace("{NAME}",$tcshopInfo['name'], lang('plugin/tom_tcshop','tel_template_first'));
            $template_first = str_replace("{MONEY}",$orderInfo['pay_price'], $template_first);
        }
