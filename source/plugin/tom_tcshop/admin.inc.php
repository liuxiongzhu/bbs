...
}else if($_GET['tmod'] == 'money'){
    include DISCUZ_ROOT.'./source/plugin/tom_tcshop/admin/money.php';
}else if($_GET['tmod'] == 'tixian'){
    include DISCUZ_ROOT.'./source/plugin/tom_tcshop/admin/tixian.php';
}else if($_GET['tmod'] == 'mallCate'){
    include DISCUZ_ROOT.'./source/plugin/tom_tcshop/admin/mallCate.php';
}else{
    include DISCUZ_ROOT.'./source/plugin/tom_tcshop/admin/index.php';
}