...
if($__IsMiniprogram == 1 && $_GET['id'] == 'tom_tongcheng'){
...
$mustLogin = true;
if($_GET['id'] == 'tom_tongcheng' && ($_GET['mod'] == 'index' || $_GET['mod'] == 'list' || $_GET['mod'] == 'info' || $_GET['mod'] == 'view' || $_GET['mod'] == 'hbao' || $_GET['mod'] == 'home')){
    $mustLogin = false;
}
...
if($_GET['id'] == 'tom_tcmall' && ($_GET['mod'] == 'index' || $_GET['mod'] == 'list' || $_GET['mod'] == 'search' || $_GET['mod'] == 'cate' || $_GET['mod'] == 'goodsinfo' || $_GET['mod'] == 'shop')){
    $mustLogin = false;
}
