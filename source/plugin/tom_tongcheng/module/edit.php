...
if($_GET['act'] == 'save' && $_GET['formhash'] == FORMHASH){
    ...
    $edit_site_id  = isset($_GET['edit_site_id'])? intval($_GET['edit_site_id']):0;
    ...
    }else if($tongchengInfo['shenhe_status'] == 3){
            $updateData['shenhe_status']       = 2;
    }
    ...
    if($_GET['edit_site_id'] > 0 && $_GET['edit_site_id'] != $tongchengInfo['site_id']){
        $tongchengInfo['site_id']   = $_GET['edit_site_id'];
        $tongchengInfo['city_id']   = $__CityInfo['id'];
        $tongchengInfo['area_id']   = 0;
        $tongchengInfo['street_id'] = 0;
    }
