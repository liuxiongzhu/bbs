...
if($formhash == FORMHASH && $act == 'info'){
    ...
    foreach ($orderList as $key => $value){
        ...
        if($value['order_type'] == 1){
            ...
            echo '<td>'.$Lang['order_type_4'].'</td>';
        }else if($value['order_type'] == 5){
            echo '<td>'.$Lang['order_type_5'].'</td>';
        }else if($value['order_type'] == 6){
            echo '<td>'.$Lang['order_type_6'].'</td>';
        }else if($value['order_type'] == 7){
            echo '<td>'.$Lang['order_type_7'].'</td>';
        }else if($value['order_type'] == 8){
            echo '<td>'.$Lang['order_type_8'].'</td>';
        }else if($value['order_type'] == 9){
            echo '<td>'.$Lang['order_type_9'].'</td>';
        }else{
            echo '<td>-</td>';
        }
