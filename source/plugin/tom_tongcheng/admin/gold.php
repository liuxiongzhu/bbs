...
if($_GET['act'] == 'add' && $_GET['formhash'] == FORMHASH){
    ...
    foreach ($scorelogList as $key => $value) {
        ...
        }else if($value['log_type'] == 13){
            $log_type = $Lang['gold_type_title13'];
        }else if($value['log_type'] == 14){
            $log_type = $Lang['gold_type_title14'];
        }else if($value['log_type'] == 15){
            $log_type = $Lang['gold_type_title15'];
        }else if($value['log_type'] == 16){
            $log_type = $Lang['gold_type_title16'];
        }else if($value['log_type'] == 17){
            $log_type = $Lang['gold_type_title17'];
        }else if($value['log_type'] == 18){
            $log_type = $Lang['gold_type_title18'];
        }else if($value['log_type'] == 19){
            $log_type = $Lang['gold_type_title19'];
        }else if($value['log_type'] == 20){
            $log_type = $Lang['gold_type_title20'];
        }
