...
if($_GET['act'] == 'add'){
    ...
    foreach ($sites_priceList as $key => $value) {
        ...
        echo '<td><font color="#f00">' . $value['fabu_price'].'</font>'. $Lang['type_price_fabu'].'&nbsp;,&nbsp;<font color="#f00">'. $value['refresh_price'].'</font>'. $Lang['type_price_refresh'] .'&nbsp;</td>';
        echo '<td><font color="#f00">' . $value['tel_price'].'</font>'. $Lang['type_price_tel'].'</td>';
        echo '<td>';
