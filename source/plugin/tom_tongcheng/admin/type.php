...
function __get_post_data($infoArr = array()){
    ...
    $jifei_type         = isset($_GET['jifei_type'])? intval($_GET['jifei_type']):1;
    $fabu_price         = isset($_GET['fabu_price'])? addslashes($_GET['fabu_price']):'';
    $fabu_price_str     = isset($_GET['fabu_price_str'])? addslashes($_GET['fabu_price_str']):'';
    ...
    $top_price_str      = isset($_GET['top_price_str'])? addslashes($_GET['top_price_str']):'';
    
    $open_tel_price     = isset($_GET['open_tel_price'])? intval($_GET['open_tel_price']):0;
    $tel_price          = isset($_GET['tel_price'])? addslashes($_GET['tel_price']):'';
...
function __create_info_html($infoArr = array()){
    ...
    $jifei_type_item = array(1=>$Lang['type_jifei_type_1'],2=>$Lang['type_jifei_type_2']);
    tomshowsetting(true,array('title'=>$Lang['type_jifei_type'],'name'=>'jifei_type','value'=>$options['jifei_type'],'msg'=>$Lang['type_jifei_type_msg'],'item'=>$jifei_type_item),"radio");
    ...
    tomshowsetting(true,array('title'=>$Lang['type_fabu_price_str'],'name'=>'fabu_price_str','value'=>$options['fabu_price_str'],'msg'=>$Lang['type_fabu_price_str_msg']),"textarea");
    ...
    tomshowsetting(true,array('title'=>$Lang['type_top_price_str'],'name'=>'top_price_str','value'=>$options['top_price_str'],'msg'=>$Lang['type_top_price_str_msg']),"textarea");
    
    $open_tel_price_item = array(0=>$Lang['type_open_tel_price_0'],1=>$Lang['type_open_tel_price_1']);
    tomshowsetting(true,array('title'=>$Lang['type_open_tel_price'],'name'=>'open_tel_price','value'=>$options['open_tel_price'],'msg'=>$Lang['type_open_tel_price_msg'],'item'=>$open_tel_price_item),"radio");
    tomshowsetting(true,array('title'=>$Lang['type_tel_price'],'name'=>'tel_price','value'=>$options['tel_price'],'msg'=>$Lang['type_tel_price_msg']),"input");
    ...
    tomshowsetting(true,array('title'=>$Lang['type_share_title'],'name'=>'share_title','value'=>$options['share_title'],'msg'=>$Lang['type_share_title_msg']),"input");
    tomshowsetting(true,array('title'=>$Lang['type_share_desc'],'name'=>'share_desc','value'=>$options['share_desc'],'msg'=>$Lang['type_share_desc_msg']),"input");
    tomshowsetting(true,array('title'=>$Lang['type_share_logo'],'name'=>'share_logo','value'=>$options['share_logo'],'msg'=>$Lang['type_share_logo_msg']),"file");
