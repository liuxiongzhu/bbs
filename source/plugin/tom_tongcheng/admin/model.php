...
function __get_post_data($infoArr = array()){
    ...
    $open_dingwei = isset($_GET['open_dingwei'])? intval($_GET['open_dingwei']):0;
    ...
    $data['open_dingwei']= $open_dingwei;
...
function __create_info_html($infoArr = array()){
    ...
    $open_dingwei_item = array(0=>$Lang['model_open_dingwei_0'],1=>$Lang['model_open_dingwei_1']);
    tomshowsetting(true,array('title'=>$Lang['model_open_dingwei'],'name'=>'open_dingwei','value'=>$options['open_dingwei'],'msg'=>$Lang['model_open_dingwei_msg'],'item'=>$open_dingwei_item),"radio");
