...
if(isset($_G['uid']) && $_G['uid'] > 0 && $_G['groupid'] == 1){
    ...
    if (!isset($tom_tongcheng_field['over_days'])) {
        $sql .= "ALTER TABLE `pre_tom_tongcheng` ADD `over_days` int(11) DEFAULT '0';\n";
    }
    if (!isset($tom_tongcheng_field['over_time'])) {
        $sql .= "ALTER TABLE `pre_tom_tongcheng` ADD `over_time` int(11) DEFAULT '0';\n";
    }
    if (!isset($tom_tongcheng_field['is_dingwei'])) {
        $sql .= "ALTER TABLE `pre_tom_tongcheng` ADD `is_dingwei` tinyint(11) DEFAULT '0';\n";
    }
    if (!isset($tom_tongcheng_field['latitude'])) {
        $sql .= "ALTER TABLE `pre_tom_tongcheng` ADD `latitude` varchar(255) DEFAULT NULL;\n";
    }
    if (!isset($tom_tongcheng_field['longitude'])) {
        $sql .= "ALTER TABLE `pre_tom_tongcheng` ADD `longitude` varchar(255) DEFAULT NULL;\n";
    }
    if (!isset($tom_tongcheng_field['address'])) {
        $sql .= "ALTER TABLE `pre_tom_tongcheng` ADD `address` varchar(255) DEFAULT NULL;\n";
    }
    ...
    if (!isset($tom_tongcheng_focuspic_field['type_id'])) {
        $sql .= "ALTER TABLE `pre_tom_tongcheng_focuspic` ADD `type_id` int(11) DEFAULT '1';\n";
    }
    if (!isset($tom_tongcheng_focuspic_field['model_id'])) {
        $sql .= "ALTER TABLE `pre_tom_tongcheng_focuspic` ADD `model_id` int(11) DEFAULT '0';\n";
    }
    ...
    if (!isset($tom_tongcheng_model_field['jifei_type'])) {
        $sql .= "ALTER TABLE `pre_tom_tongcheng_model` ADD `jifei_type` int(11) DEFAULT '1';\n";
    }
    if (!isset($tom_tongcheng_model_field['share_title'])) {
        $sql .= "ALTER TABLE `pre_tom_tongcheng_model` ADD `share_title` varchar(255) DEFAULT NULL;\n";
    }
    if (!isset($tom_tongcheng_model_field['share_desc'])) {
        $sql .= "ALTER TABLE `pre_tom_tongcheng_model` ADD `share_desc` varchar(255) DEFAULT NULL;\n";
    }
    if (!isset($tom_tongcheng_model_field['share_logo'])) {
        $sql .= "ALTER TABLE `pre_tom_tongcheng_model` ADD `share_logo` varchar(255) DEFAULT NULL;\n";
    }
    if (!isset($tom_tongcheng_model_field['open_dingwei'])) {
        $sql .= "ALTER TABLE `pre_tom_tongcheng_model` ADD `open_dingwei` int(11) DEFAULT '0';\n";
    }
    ...
    if (!isset($tom_tongcheng_user_field['shop_money'])) {
        $sql .= "ALTER TABLE `pre_tom_tongcheng_user` ADD `shop_money` decimal(10,2) DEFAULT '0.00';\n";
    }
    if (!isset($tom_tongcheng_user_field['shop_tixian_money'])) {
        $sql .= "ALTER TABLE `pre_tom_tongcheng_user` ADD `shop_tixian_money` decimal(10,2) DEFAULT '0.00';\n";
    }
    if (!isset($tom_tongcheng_user_field['site_id'])) {
        $sql .= "ALTER TABLE `pre_tom_tongcheng_user` ADD `site_id` int(11) DEFAULT '0';\n";
    }
    ...
    if (!isset($tom_tongcheng_model_type_field['top_price_str'])) {
        $sql .= "ALTER TABLE `pre_tom_tongcheng_model_type` ADD `top_price_str` varchar(255) DEFAULT NULL;\n";
    }
    if (!isset($tom_tongcheng_model_type_field['open_tel_price'])) {
        $sql .= "ALTER TABLE `pre_tom_tongcheng_model_type` ADD `open_tel_price` int(11) DEFAULT '0';\n";
    }
    if (!isset($tom_tongcheng_model_type_field['tel_price'])) {
        $sql .= "ALTER TABLE `pre_tom_tongcheng_model_type` ADD `tel_price` decimal(10,2) DEFAULT '0.00';\n";
    }
    if (!isset($tom_tongcheng_model_type_field['fabu_price_str'])) {
        $sql .= "ALTER TABLE `pre_tom_tongcheng_model_type` ADD `fabu_price_str` varchar(255) DEFAULT NULL;\n";
    }
    if (!isset($tom_tongcheng_model_type_field['jifei_type'])) {
        $sql .= "ALTER TABLE `pre_tom_tongcheng_model_type` ADD `jifei_type` int(11) DEFAULT '1';\n";
    }
    if (!isset($tom_tongcheng_model_type_field['share_title'])) {
        $sql .= "ALTER TABLE `pre_tom_tongcheng_model_type` ADD `share_title` varchar(255) DEFAULT NULL;\n";
    }
    if (!isset($tom_tongcheng_model_type_field['share_desc'])) {
        $sql .= "ALTER TABLE `pre_tom_tongcheng_model_type` ADD `share_desc` varchar(255) DEFAULT NULL;\n";
    }
    if (!isset($tom_tongcheng_model_type_field['share_logo'])) {
        $sql .= "ALTER TABLE `pre_tom_tongcheng_model_type` ADD `share_logo` varchar(255) DEFAULT NULL;\n";
    }
    ...
    $tom_tongcheng_refresh_log_field = C::t('#tom_tongcheng#tom_tongcheng_refresh_log')->fetch_all_field();
    if (!isset($tom_tongcheng_refresh_log_field['user_id'])) {
        $sql .= "ALTER TABLE `pre_tom_tongcheng_refresh_log` ADD `user_id` int(11) DEFAULT '0';\n";
    }
    ...
    CREATE TABLE IF NOT EXISTS `pre_tom_tongcheng_fabu_log` (
        `id` int(11) NOT NULL AUTO_INCREMENT,
        `user_id` int(11) DEFAULT '0',
        `tongcheng_id` int(11) DEFAULT '0',
        `time_key` int(11) DEFAULT '0',
    ...
    CREATE TABLE IF NOT EXISTS `pre_tom_tongcheng_sites_cate` (
      `id` int(11) NOT NULL AUTO_INCREMENT,
      `name` varchar(255) DEFAULT NULL,
      `paixu` int(11) DEFAULT '100',
      `add_time` int(11) DEFAULT '0',
...
EOF;
    ...
    if (!isset($tom_tongcheng_sites_field['114_fc_scale'])) {
        $sql .= "ALTER TABLE `pre_tom_tongcheng_sites` ADD `114_fc_scale` int(11) DEFAULT '0';\n";
    }
    if (!isset($tom_tongcheng_sites_field['vip_fc_scale'])) {
        $sql .= "ALTER TABLE `pre_tom_tongcheng_sites` ADD `vip_fc_scale` int(11) DEFAULT '0';\n";
    }
    ...
    if (!isset($tom_tongcheng_sites_field['mall_fc_scale'])) {
        $sql .= "ALTER TABLE `pre_tom_tongcheng_sites` ADD `mall_fc_scale` int(11) DEFAULT '0';\n";
    }
    if (!isset($tom_tongcheng_sites_field['ruzhu_price'])) {
        $sql .= "ALTER TABLE `pre_tom_tongcheng_sites` ADD `ruzhu_price` decimal(10,2) DEFAULT '0.00';\n";
    }
    if (!isset($tom_tongcheng_sites_field['vip_ruzhu_price'])) {
        $sql .= "ALTER TABLE `pre_tom_tongcheng_sites` ADD `vip_ruzhu_price` decimal(10,2) DEFAULT '0.00';\n";
    }
    if (!isset($tom_tongcheng_sites_field['vip_ruzhu_price_two'])) {
        $sql .= "ALTER TABLE `pre_tom_tongcheng_sites` ADD `vip_ruzhu_price_two` decimal(10,2) DEFAULT '0.00';\n";
    }
    if (!isset($tom_tongcheng_sites_field['cate_id'])) {
        $sql .= "ALTER TABLE `pre_tom_tongcheng_sites` ADD `cate_id` int(11) DEFAULT '0';\n";
    }
    if (!isset($tom_tongcheng_sites_field['is_hot'])) {
        $sql .= "ALTER TABLE `pre_tom_tongcheng_sites` ADD `is_hot` int(11) DEFAULT '1';\n";
    }
    if (!isset($tom_tongcheng_sites_field['paixu'])) {
        $sql .= "ALTER TABLE `pre_tom_tongcheng_sites` ADD `paixu` int(11) DEFAULT '1000';\n";
    }
    if (!isset($tom_tongcheng_sites_field['open_sites'])) {
        $sql .= "ALTER TABLE `pre_tom_tongcheng_sites` ADD `open_sites` int(11) DEFAULT '1';\n";
    }
    if (!isset($tom_tongcheng_sites_field['index_color_menu'])) {
        $sql .= "ALTER TABLE `pre_tom_tongcheng_sites` ADD `index_color_menu` text;\n";
    }
    if (!isset($tom_tongcheng_sites_field['index_white_menu'])) {
        $sql .= "ALTER TABLE `pre_tom_tongcheng_sites` ADD `index_white_menu` text;\n";
    }
    if (!isset($tom_tongcheng_sites_field['tt_fc_scale'])) {
        $sql .= "ALTER TABLE `pre_tom_tongcheng_sites` ADD `tt_fc_scale` int(11) DEFAULT '0';\n";
    }
    ...
    $tom_tongcheng_pinglun_field = C::t('#tom_tongcheng#tom_tongcheng_pinglun')->fetch_all_field();
    if (!isset($tom_tongcheng_pinglun_field['touser_id'])) {
        $sql .= "ALTER TABLE `pre_tom_tongcheng_pinglun` ADD `touser_id` int(11) DEFAULT '0';\n";
    }
    if (!isset($tom_tongcheng_pinglun_field['touser_nickname'])) {
        $sql .= "ALTER TABLE `pre_tom_tongcheng_pinglun` ADD `touser_nickname` varchar(255) DEFAULT NULL;\n";
    }
    if (!isset($tom_tongcheng_pinglun_field['touser_avatar'])) {
        $sql .= "ALTER TABLE `pre_tom_tongcheng_pinglun` ADD `touser_avatar` varchar(255) DEFAULT NULL;\n";
    }
    
    $tom_tongcheng_sites_price_field = C::t('#tom_tongcheng#tom_tongcheng_sites_price')->fetch_all_field();
    if (!isset($tom_tongcheng_sites_price_field['top_price_str'])) {
        $sql .= "ALTER TABLE `tom_tongcheng_sites_price` ADD `top_price_str` varchar(255) DEFAULT NULL;\n";
    }
    if (!isset($tom_tongcheng_sites_price_field['tel_price'])) {
        $sql .= "ALTER TABLE `tom_tongcheng_sites_price` ADD `tel_price` decimal(10,2) DEFAULT '0.00';\n";
    }
    if (!isset($tom_tongcheng_sites_price_field['fabu_price_str'])) {
        $sql .= "ALTER TABLE `tom_tongcheng_sites_price` ADD `fabu_price_str` varchar(255) DEFAULT NULL;\n";
    }
