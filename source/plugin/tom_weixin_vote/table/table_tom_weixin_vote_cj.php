...
class table_tom_weixin_vote_cj extends discuz_table{
	public function __construct() {
        parent::__construct();
		$this->_table = 'tom_weixin_vote_cj';
		$this->_pk    = 'id';
	}
    ...
    public function fetch_by_v_u_t($vote_id,$user_id,$time_key) {
		return DB::fetch_first("SELECT * FROM %t WHERE vote_id=%d AND user_id=%d AND time_key=%d ", array($this->_table, $vote_id,$user_id,$time_key));
	}
