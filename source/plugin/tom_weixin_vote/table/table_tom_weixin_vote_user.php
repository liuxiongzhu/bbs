...
class table_tom_weixin_vote_user extends discuz_table{
	public function __construct() {
        parent::__construct();
		$this->_table = 'tom_weixin_vote_user';
		$this->_pk    = 'id';
	}
    ...
    public function fetch_by_vid_openid($vid,$openid) {
		return DB::fetch_first("SELECT * FROM %t WHERE vote_id=%d AND part1=%s ", array($this->_table, $vid,$openid));
	}
