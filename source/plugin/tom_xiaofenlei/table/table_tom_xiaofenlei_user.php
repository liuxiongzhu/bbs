...
class table_tom_xiaofenlei_user extends discuz_table{
	public function __construct() {
        parent::__construct();
		$this->_table = 'tom_xiaofenlei_user';
		$this->_pk    = 'id';
	}
	...
	public function fetch_by_utoken($utoken,$field='*') {
		return DB::fetch_first("SELECT $field FROM %t WHERE utoken=%s", array($this->_table, $utoken));
	}
