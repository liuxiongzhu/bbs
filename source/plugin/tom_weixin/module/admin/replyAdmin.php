...
$replyListUrl = $moduleListUrl.'&act=admin&moduleid=reply';
if($_GET['mact'] == 'add'){
    if(submitcheck('submit')){
        ...
        $reply_text = '';
        if($_GET['replytype'] == 1){
            $wbtxt = isset($_GET['wbtxt'])? addslashes($_GET['wbtxt']):'';
            $reply_text = $wbtxt;
        ...
        showformheader($moduleFromUrl.'&act=admin&moduleid=reply&mact=add&replytype='.$_GET['replytype']);
        showtableheader();
    ...
    if(submitcheck('submit')){
        ...
        showformheader($moduleFromUrl.'&act=admin&moduleid=reply&mact=edit&id='.$_GET['id']);
        showtableheader();
        echo '<tr><th colspan="15" class="partition"><a href="'.$replyBaseUrl.'"><font color="#F60"><b>' . $moduleLang['reply_list_back'] . '</b></font></a></th></tr>';
        echo '<tr class="header"><th>'.$moduleLang['reply_cmd'].'</th><th></th></tr>';
