...
echo '<script src="source/plugin/tom_tchehuoren/images/admin.js"></script>';

function get_tchehuoren_config($pluginid){
    ...
    foreach ($pluginVarList as $vark => $varv){
        $tchehuorenConfig[$varv['variable']] = $varv['value'];
    }
    
    return $tchehuorenConfig;
}
