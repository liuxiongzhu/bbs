...
class table_tom_tchehuoren_dengji extends discuz_table{
	public function __construct() {
        parent::__construct();
		$this->_table = 'tom_tchehuoren_dengji';
		$this->_pk    = 'id';
	}
    ...
    public function fetch_by_level($level,$field='*') {
		return DB::fetch_first("SELECT $field FROM %t WHERE level=%d", array($this->_table, $level));
	}
